...
namespace TechHub.Controllers
{
    public class SkillsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Type,Level,Description")] Skill skill)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int? id, [Bind("ID,Type,Level,Description")] Skill skill)
        {
            if (id != skill.ID)
            {
                return NotFound();
